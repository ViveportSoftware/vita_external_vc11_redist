...
var product = "Htc.Vita.External.VC11.Redist";
var companyName = "HTC";
var version = "11.0.61030";
var semanticVersion = string.Format("{0}.{1}", version, revision);
var ciVersion = string.Format("{0}.{1}", version, "0");
var nugetTags = new [] {"htc", "vita", "external", "vc11", "redist"};
var projectUrl = "https://github.com/ViveportSoftware/vita_external_vc11_redist/";
var description = "HTC Vita external package: VC11 redistributable";
...
// Define path
var targetFileNameX64 = string.Format("vcredist_2012_x64-{0}.exe", version);
var targetFileNameX86 = string.Format("vcredist_2012_x86-{0}.exe", version);
var targetFileUrlX64 = "https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x64.exe";
var targetFileUrlX86 = "https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x86.exe";
